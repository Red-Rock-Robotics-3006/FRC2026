...
public class LerpingSmartDashboardNumber {
    ...
    public double convertByInputRate(double val) {
        return ((outputUpperBound.getNumber() - outputLowerBound.getNumber()) / (inputUpperBound.getNumber() - inputLowerBound.getNumber())) * val;
    }
