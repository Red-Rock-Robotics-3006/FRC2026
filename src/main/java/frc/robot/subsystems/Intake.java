...
public class Intake extends SubsystemBase{
    ...
    private SmartDashboardNumber intakeDeployPosition = new SmartDashboardNumber("intake/extension/deploy position", 0.4, kEnableTuning && false);
    ...
    private SmartDashboardNumber intakePositionTolerance = new SmartDashboardNumber("intake/extension/position tolerance", 0.6, kEnableTuning && false);
    ...
    public Command shootRaiseHopperCommand() {
        return Commands.sequence(
            Commands.runOnce(() -> this.startPulsateIntake()),
            Commands.runOnce(() -> this.pushRetractIntake(), this)
        );
